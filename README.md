...
**[Download artifacts.zip](https://drive.google.com/file/d/1H-LAu7L4xwlrO1uiGErB6yys6uJ8alcA/view?usp=sharing)**
...
5. If you are storing artifacts externally, use this Google Drive archive as the source:

**[Download artifacts.zip](https://drive.google.com/file/d/1H-LAu7L4xwlrO1uiGErB6yys6uJ8alcA/view?usp=sharing)**

6. If you are configuring a downloader in Render, the Google Drive file ID is:

```text
1H-LAu7L4xwlrO1uiGErB6yys6uJ8alcA
```
